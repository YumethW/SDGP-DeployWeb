...
const TC = () => {
  return (
    <div className="privacy-policy">
      ...
      <p>
        These terms and conditions apply to the Bokka fit app (hereby referred
        to as "Application") for mobile devices that was created by Bokka fit
      ...
      <ul>
        ...
        <li>
          <a href="https://expo.io/terms">Expo</a>
        </li>
      </ul>
      <p>
      ...
      <p>These terms and conditions are effective as of 2024-03-31</p>
      <h3>Contact Us</h3>
      <p>
